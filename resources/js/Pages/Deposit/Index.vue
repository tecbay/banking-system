    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex justify-between">
                ...
                <PrimaryButton @click="()=>router.get(route('deposits.create'))">New Deposit</PrimaryButton>
            </div>
                        ...
                        <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                            <table class="min-w-full divide-y divide-gray-300">
                                ...
                                <tr v-for="deposit in deposits" :key="deposit.id">
                                    ...
                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500 uppercase">{{ deposit.transaction_type }}</td>
                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ deposit.fee }}</td>
                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ deposit.date }}</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
